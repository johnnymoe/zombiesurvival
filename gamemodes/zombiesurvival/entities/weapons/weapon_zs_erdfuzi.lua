...
SWEP.ViewModelBoneMods = {
	...
	SWEP.HUD3DBone = "v_weapon.p228_Parent"
	SWEP.HUD3DPos = Vector(-0, -4.35,5.55)
...
function SWEP:EmitFireSound()
    self:EmitSound(self.Primary.Sound, 100, math.random(122,124))
	self:EmitSound("weapons/glock/glock18-1.wav", 100, 137, 0.53, CHAN_AUTO+20)
	self:EmitSound("weapons/g3sg1/g3sg1-1.wav", 100, 161, 0.53, CHAN_AUTO+20)
	end
