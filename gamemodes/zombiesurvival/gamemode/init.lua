...
function GM:AddResources()
	...
	resource.AddFile("models/weapons/v_zombiearms_update.mdl")
	...
	resource.AddFile("materials/models/weapons/v_zombiearms/zombie_classic_sleeves.vmt")
	resource.AddFile("materials/models/weapons/v_zombiearms/zombie_classic_sleeves.vtf")
